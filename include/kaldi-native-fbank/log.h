...
#define KNF_LOG(level, fmt, ...)                       \
  knf_log_message(level, __FILE__, __func__, __LINE__, \
                  fmt __VA_OPT__(, ) __VA_ARGS__)
#define KNF_LOG_TRACE(fmt, ...) \
  KNF_LOG(KNF_LOG_TRACE, fmt __VA_OPT__(, ) __VA_ARGS__)
#define KNF_LOG_DEBUG(fmt, ...) \
  KNF_LOG(KNF_LOG_DEBUG, fmt __VA_OPT__(, ) __VA_ARGS__)
#define KNF_LOG_INFO(fmt, ...) \
  KNF_LOG(KNF_LOG_INFO, fmt __VA_OPT__(, ) __VA_ARGS__)
#define KNF_LOG_WARN(fmt, ...) \
